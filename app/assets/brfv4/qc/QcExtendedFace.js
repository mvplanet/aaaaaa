...
(function(lib) {
	...
	lib.BRFv4ExtendedFace.prototype.addUpperForeheadPoints = function(v) {
		...
		var baseDist = this.calcDistance(p0, p1) * 1.2;
		...
		var distEyes = this.calcDistance(p0, p1)*1.2;
		...
		var f = 0.5-this.calcDistance(p0, p5) / distEyes*1.2;

		// outer left forehead point

		this.setPoint(v, 0, p5); // top left outline point
		var dist = this.calcDistance(p0, p5) * 0.75*1.2;
